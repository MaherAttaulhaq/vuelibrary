    ...
    <div class="mx-auto max-w-container px-4 md:px-8">
      <div class="flex flex-col justify-between gap-x-8 gap-y-12 lg:flex-row">
        <div class="flex flex-col gap-8 md:items-start">
          <div class="flex h-7 w-min items-center justify-start overflow-visible">
        ...
        <form class="flex w-full flex-col gap-4 sm:max-w-90" @submit.prevent="onSubmitNewsletter">
          <label for="newsletter-email" class="text-sm font-semibold text-primary">
            Stay up to date
          </label>
          <div class="flex flex-col gap-4 sm:flex-row">
            <UInput
              ...
              class="flex-1"
            />
            <UButton type="submit" variant="solid" color="primary" :loading="isLoading">
              Subscribe
            </UButton>
          </div>
        </form>
