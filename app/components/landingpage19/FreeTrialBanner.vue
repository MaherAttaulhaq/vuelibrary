<template>
  <section class="bg-muted pb-16 md:pb-24">
    <div class="mx-auto max-w-container px-4 md:px-8">
      <div
        class="flex flex-col gap-x-8 gap-y-8 rounded-2xl bg-muted-100 dark:bg-muted-900 px-6 py-10 lg:flex-row lg:p-16"
      >
        <div class="flex max-w-3xl flex-1 flex-col">
          ...
          <p class="mt-4 text-lg text-muted-600 dark:text-muted-400 lg:text-xl">
            Join over 4,000+ startups already growing with Untitled.
          </p>
        </div>
        <div
          class="flex flex-col-reverse items-stretch gap-3 sm:flex-row sm:items-start"
        >
